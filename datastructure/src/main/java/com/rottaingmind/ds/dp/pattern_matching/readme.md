...
No matter which condition is going to tru i and j is reducing here so at a point its can we 0/-ve
if(i < 0) // S : ""
 check if P[0...j] == ***.. return true else false

we have to traver P here from 0... j, can we make it o(1) rather that o (n)
Example:
S: ""
P: ****ab?*
