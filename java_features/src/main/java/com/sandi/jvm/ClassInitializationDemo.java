...
// Its loaded only if its static method invoked OR one of its not compile time fields invoked
...
public class ClassInitializationDemo {
	...
	public static void main(String[] args) throws Exception { 		
	    ...
	    System.out.println("Subclass.STATIC_FINAL: " + Subclass.STATIC_FINAL);// This will not load Subclass because Subclass.STATIC_FINAL is compile time constant
	    //System.out.println("Subclass.stringLiteral: " + Subclass.stringLiteral);
	    System.out.println("Invoking Subclass.STATIC_FINAL2  ... ");
		System.out.println("Subclass.STATIC_FINAL2: " + Subclass.STATIC_FINAL2); // Subclass.STATIC_FINAL2 is not a compile time constant
		// time constant, it assign this value by calling Math.random() method
